...
char **copy_env(info *myinfo)
{
	...
	myinfo->modified_env = list_string(myinfo->env_list); /*custom*/
...
{	/*declare the variables*/
	...
	variable_len = string_length(variable); /*custom*/
